...
import com.mv.beers.ui.view.adapter.adapter.BeerAdapter
...
class PrincipalFragment : Fragment()  {
    ...
    override fun onCreateView (
        ...
        btnFavoritos.setOnClickListener {
            findNavController().navigate(R.id.action_principalFragment_to_favoritos)
        }
        ...
        beerViewModel.beerModel.observe(viewLifecycleOwner) {
            recyclerView.adapter = BeerAdapter(it) { beerItem ->
                ...
                findNavController().navigate(R.id.action_principalFragment_to_ventanaDetalles)
            }
